...
import { userColumn, cameraInfoField, gnssInfoField } from '@/utils/table-column-match'
import {
  serviceQuery,
  serviceAdd,
  serviceUpdate,
...
export default {
  ...
  mounted() {
    this.$refs.table.getShowCols(this.tableData, userColumn)
    setTimeout(() => {
