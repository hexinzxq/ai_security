    ...
    <div class="box-card">
      <div>
        <common-table
          ...
          :table-column-match="materialColumn"
...
import { materialColumn, cameraInfoField, gnssInfoField } from '@/utils/table-column-match'
import {
  serviceQuery,
  serviceAdd,
  serviceUpdate,
...
export default {
  ...
  mounted() {
    this.$refs.table.getShowCols(this.tableData, materialColumn)
    setTimeout(() => {
